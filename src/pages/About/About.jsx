      ...
      <div className="w-11/12 mx-auto">
        <div className="flex flex-col md:flex-row items-center w-full gap-10 py-12">
          <div className="w-full md:w-[55%]">
            <h1 className='text-2xl text-slate-800 font-bold pb-2'>Your Premier Destination for Residential Real Estate</h1>
            ...
            <h1 className='text-2xl text-slate-800 font-bold pb-2'>Crafting Dreams into Realty</h1>
            ...
            <h1 className='text-2xl text-slate-800 font-bold pb-2'>Unraveling Boundless Opportunities</h1>
