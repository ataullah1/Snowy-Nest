  ...
  return (
    <div className="w-11/12 mx-auto flex flex-col-reverse md:flex-row gap-4 md:gap-8 lg:gap-28 justify-between">
      <div className="w-full md:w-3/5">
        ...
        <p
          data-aos="zoom-out-down"
          className="max-w-[600px] text-slate-400 my-6"
        >
        ...
        <div className="shadow-lg h-80 mt-10 rounded-lg  grid grid-cols-2">
          <div className="w-full flex items-center justify-center bg-red-300 rounded-tl-lg">
          ...
          <div className="w-full text-center flex items-center justify-center bg-gray-300 rounded-tr-lg">
            <div className="text-center p-3">
              <span className="mx-auto inline-block text-6xl">
                <MdCall />
              </span>
          ...
          <div className="w-full text-center flex items-center justify-center bg-green-200 rounded-bl-lg">
            <div className="text-center p-3">
              <span className="mx-auto inline-block text-6xl">
                <MdWhatsapp />
              </span>
          ...
          <div className="w-full text-center flex items-center justify-center bg-yellow-300 rounded-br-lg">
            <div className="text-center p-3">
              <span className="mx-auto inline-block text-6xl">
                <SiGmail />
              </span>
