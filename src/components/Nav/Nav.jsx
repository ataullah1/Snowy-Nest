        ...
        <div className=" navbar flex items-center flex-col sm:flex-row sm:justify-between">
          <div className="navbar-start flex items-center flex-row-reverse justify-between w-full sm:w-auto sm:flex-row">
            <div className="dropdown">
              ...
              <ul
                tabIndex={0}
                className="menu menu-sm dropdown-content mt-3 ml-[-140px] sm:ml-0 z-[1] p-2 shadow rounded-box w-52 border-2 border-solid border-redLi bg-slate-400"
              >
                <NavLink
                  to={'/'}
          ...
          <div className="navbar-end gap-4 hidden sm:flex w-auto">
            <Link
              to={'login'}
              className="font-semibold hover:bg-white hover:text-redLi px-5 sm:px-8 py-2 sm:py-3 rounded-md border border-redLi active:scale-90 duration-150 text-redLi"
            >
              Login
            </Link>
            <Link
              to={'register'}
              className="font-semibold bg-white text-redLi px-5 sm:px-8 py-2 sm:py-3 rounded-md active:scale-90 duration-150"
            >
              Register
            </Link>
          </div>
